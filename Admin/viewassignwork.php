...
<div class="col-sm-6 mt-5 mx-5">
    ...
    <div class="text-center mb-3">
        <form action="work.php" class="d-inline d-print-none mr-3">   
            <input class="btn btn-danger"type="submit" value="Print" onclick="window.print()">     
        </form>
        <form action="work.php" class="d-print-none d-inline"><input class="btn btn-secondary" type="submit" value="Close"></form>  
    </div>             
    <?php } ?>
</div>
<!-- End 2nd Column -->
