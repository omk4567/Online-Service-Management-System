  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert">All Fields are Mandatory.</div>';     
        ...
        $sql = "INSERT INTO submitrequest_tb(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, request_date) VALUES ('$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip', '$remail', '$rmobile', '$rdate')";    
         ...
         if($conn->query($sql) == TRUE){
            ...
            $msg = '<div class="alert alert-danger col-sm-6 ml-5 mt-2" role="alert"> Unable to Submit Request. </div>';   
         }     
    }
}
?>                  
...
<form class="mx-5" action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputZip" name="requesterzip"  pattern="\d{6}" maxlength="6" onkeypress="isInputNumber(event)">
      </div>
    </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-2">
        ...
        <input type="text" class="form-control" id="inputMobile" name="requestermobile"  pattern="\d{10}" maxlength="10" onkeypress="isInputNumber(event)">
      </div>
      <div class="form-group col-md-2">
