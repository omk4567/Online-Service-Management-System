...
<body>    
     <!-- Start Navigation -->
  <nav id="navbar" class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">ServicePlus</a>
   ...
   <div class="myclass mainHeading">   
    <h1 class="text-uppercase text-danger font-weight-bold">Welcome to <br> ServicePlus</h1>     
   ...
   <!-- Start Introduction Section -->
    <div class="container">
        <div class="jumbotron">
            <h3 class="text-center">ServicePlus Services</h3>   
            <p>
        ...
        <div class="container">
            <div class="row py-3">
                ...
                <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
                    <small>Designed by Omkar Aher &copy; 2024</small>
